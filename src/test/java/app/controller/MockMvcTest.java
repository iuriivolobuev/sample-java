 ...
 *
 * <p>Annotations is a much better way to share common configuration than extending a common test class:
 * <ul>
 ...
 */
@WebAppConfiguration
@ContextConfiguration({"classpath:/test-context.xml", "classpath:/dao-context.xml", "classpath:/web-context.xml"})
